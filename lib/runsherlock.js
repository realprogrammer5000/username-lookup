...
module.exports = async (username, timeout, real, page, pageSize) => {
    ...
    parsed.forEach((data, idx) => {
        ...
        // console.log(data.name, sortedSites.map(site => site[0]));
...
if(require.main === module){
    module.exports("realdonaldtrump", 20000, true, 1, 30).then(data => fs.writeFile("testresources/realdonaldtrump.json", JSON.stringify(data, null, "  ")));
}
